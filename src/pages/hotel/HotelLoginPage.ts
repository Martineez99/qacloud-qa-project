...
export class HotelLoginPage extends BasePage {
  ...
  async navigate(): Promise<void> {
    ...
    await this.page.goto(`/app-login.html?user=${username}&app=hotel`);
    await this.waitForPageLoad();
  }

  /**
   * Hace login en la Hotel app con el token dado.
   ...
   * Es el método que usa hotel.setup.ts.
   */
  ...
  async expectLoggedIn(): Promise<void> {
    await expect(this.page).toHaveURL(/hotel\.html/, { timeout: 15_000 });
  }
