...
- Name: sandbox\smoke.spec.ts >> @smoke — Platform connectivity >> Market app loads correctly
- Location: src\e2e\sandbox\smoke.spec.ts:10:7
...
Expected pattern: /Market|QA Cloud/i
Received string:  "Error"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    8 × unexpected value "Error"
...
```yaml
- generic [ref=e2]: Cannot GET /market
```
